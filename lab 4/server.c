       ...
       { 
           ...
           while(1){
            ...
            //    if(client_data->a == 0 && client_data->b ==0){
               ...
               if (client_data->name == 0 && client_data->age == 0 && client_data->group == 0) {
                   close(comm_socket_fd);
            ...
            //    OLD:
            //    result.concat = client_data->a + client_data->b;

               strcpy(result.concat, "Name: "); 
               strcat(result.concat, client_data->name);
               strcat(result.concat, "; Age: "); 
               strcat(result.concat, client_data->age);
               strcat(result.concat, "; Group: ");
               strcat(result.concat, client_data->group);
